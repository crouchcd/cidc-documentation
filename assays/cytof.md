...
5. The CIMAC technician or CIMAC bioinformatics support transfers the metadata and the raw and proccessed FCS files to a CIDC upload bucket, following the concierge model.
6. The CIDC engineer transfers the metadata and the raw and proccessed FCS files to CIDC using the command line tool.
...
Click [here](https://cimac-cidc.github.io/cidc-schemas/docs/assays.cytof.cytof_template.html) to see the specific metadata collected for the CyTOF assay.
